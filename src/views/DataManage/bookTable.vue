...
export default class BookList extends Vue {
  @Action("bookList") private actionBookList:any;
  @Action("clearBookList") private actionClearBookList:any;
  @Getter("bookList") private getterBookList:any;
  ...
  private addBook() {
    ...
    //Vue.prototype.success("执行新增操作");
  }
  private editBook(row:any) {
   // this.$message.success("执行编辑操作");
  }
  private delBook(row:any) {
